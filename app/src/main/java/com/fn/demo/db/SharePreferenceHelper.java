...
public class SharePreferenceHelper {
    ...
    private static class ExPreferencesUtilHolder {
        private static final SharePreferenceHelper epu = new SharePreferenceHelper();
    }

    public static final SharePreferenceHelper getInstance() {
        return SharePreferenceHelper.ExPreferencesUtilHolder.epu;
    }
