                        ...
                        if (callback != null) {
                            ...
                            switch (code) {
                                ...
                                case HttpStatus.STATUS_NO_NET:
                                    if (builder.httpCallback instanceof BitmapCallback) {
                                        builder.httpCallback.onFailed(builder.what, code, "", ExConvertUtil.getInstance().bytesToBitmap(httpResponse.getResponseBody()));
                                    } else if(builder.httpCallback instanceof FileCallback) {
                                        builder.httpCallback.onFailed(builder.what, code, "", httpResponse.getResponseBody());
                                    } else {
